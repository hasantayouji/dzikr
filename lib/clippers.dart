...
class BottomWaveClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    var bottomControlPoint = Offset(size.width / 3.5, size.height);
    var bottomEndPoint = Offset(size.width, size.height - 40);
...
//    var bottomControlPoint2 = new Offset(size.width * 0.75, size.height * 0.75);
//    var bottomEndPoint2 = new Offset(0.0, 0.0);
